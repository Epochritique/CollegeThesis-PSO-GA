function GA_FitVal = GA_GetFitValues(GA_PS, GA_Chroms, ProbDim, DimMinMax)
    ...
    for RowNum = 1:GA_PS
        ...
        g1 = 85.334407 + 0.0056858*GA_Chroms(RowNum, 2)*GA_Chroms(RowNum, 5) + 0.00026*GA_Chroms(RowNum, 1)*GA_Chroms(RowNum, 4) - 0.0022053*GA_Chroms(RowNum, 3)*GA_Chroms(RowNum, 5);
