function SibRep = GA_CrossOver(Parent1, Parent2, GA_cross, ProbDim, NodeCnt, VecCnt, alp, DimMinMax)
    CrossVal = rand();
    % Cross or Not
    ...
    Sib1_FitVal = PSO_GA_Eval(Sibling1, ProbDim, NodeCnt, VecCnt, alp, DimMinMax);
    Sib2_FitVal = PSO_GA_Eval(Sibling2, ProbDim, NodeCnt, VecCnt, alp, DimMinMax);
